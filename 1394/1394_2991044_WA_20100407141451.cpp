...
#include<iostream>
using namespace std;
int n,m,a[150],b[150],pb[150],c[150]={0},d[150]={0},pc[150],g[150];
int ta[150],tb[150],sp=0;

void rnd(){
    int i,j;
    for(i=1;i<=n;i++){ta[i]=(rand() % 5000+5000)*a[i];}
    for(i=1;i<=m;i++){tb[i]=(rand() % 5000+5000)*b[i];pb[i]=i;}
