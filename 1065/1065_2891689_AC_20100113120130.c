...
long long cj(int a,int b,int c){
return (long long)(px[a]-px[c])*(long long)(py[b]-py[c])-(long long)(px[b]-px[c])*(long long)(py[a]-py[c]);
}
long long cj2(int a,int b,int c){
return (long long)(px[a]-px[c])*(long long)(my[b]-py[c])-(long long)(mx[b]-px[c])*(long long)(py[a]-py[c]);
}
int check(int a,int b,int c,int x){
if(cj2(a,x,c)*cj2(b,x,c)>0)return 0;
return 1;
}
