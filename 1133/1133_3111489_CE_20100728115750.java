...
BigInteger a[]=new BigInteger[5000],f[]=new BigInteger[5000],e=new BigInteger("2000000000"),;
int i,j,k,n,t;
...
if(a[k].compareTo(e)>0)a[k]=new BigInteger("2000000001");
if(a[k].compareTo(e.negate)<0)a[k]=new BigInteger("-2000000001");
}
