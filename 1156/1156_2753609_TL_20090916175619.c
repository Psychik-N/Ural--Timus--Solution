#include <stdio.h>
int main(){
int n,m,i,j,k,ks=0,kl1[110],kl2[110],k1[110][110],k2[110][110],a,b,s1,s2,fs[110][110],xk[110][110];
char c[110][110]={0},cr[110][110]={1},z[110]={0};
scanf("%d%d",&n,&m);
for(i=0;i<m;i++){
scanf("%d%d",&a,&b);
c[a][b]=c[b][a]=1;
...
if(s1!=n-s1)system("pause");
for(i=1;i<=n;i++)for(j=1;j<=n;j++)
if(i!=j&&z[i]==z[j]&&c[i][j]==1)while(1);
